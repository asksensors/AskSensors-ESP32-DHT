 ...
 * Description: This examples connects the ESP32 to wifi, and sends Temperature and humidity to askSensors IoT platfom over HTTPS GET Request.
...
// user config: TODO
const char* ssid = "Orange-954C";             // SSID
const char* password = "FFTE04RYYBF";         // WIFI
const char* apiKeyIn = "ONKMHCC38YT74K5NGT8JC1GF8B1O9QKT";      // API KEY IN
